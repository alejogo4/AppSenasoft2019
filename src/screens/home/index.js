...
class Home extends Component {
  ...
  listarCategoria () {
    ...
    return [0, 1, 2, 3].map ((ee, ii) => (
      <Row key={ee} style={styles.col}>
        {categorias.slice (cont, (cont += 3)).map ((e, i) => (
          <Col key={i} style={styles.me_col}>
            <TouchableOpacity
              onPress={() => {
                this.abrirInfoCategoria (e.cat);
              }}
              style={{backgroundColor: e.color, ...styles.columns}}
            >
              <Icon3
                name={e.icon}
                style={{
      ...
      <Container style={styles.container}>
        <Content>
          ...
          <View style={styles.container_text_intro}>
            ...
            <Text style={styles.text_head_p}>
              SENASOFT es el mayor encuentro de tecnología realizado por el SENA, como iniciativa de la red de conocimiento en informática, Diseño Y Desarrollo de Software.
            </Text>
                ...
                <ScrollView style={{flex: 1}}>
                  <ScrollView
                    style={{
                      ...
                      padding: 30,
                      paddingTop: 60,
                      backgroundColor: categorias[this.state.indice].color,
                    }}
                  >
                    <Text
                      style={{
                        color: categorias[this.state.indice].iconColor,
                        fontSize: 25,
                      }}
                    >
                      {categorias[this.state.indice].nombre.toUpperCase ()}
                    </Text>
                    <Tabs
                      style={stylesTab.tabHead}
                      tabBarUnderlineStyle={{
                        backgroundColor: categorias[this.state.indice]
                          .iconColor,
                      }}
                      renderTabBar={() => (
                        <ScrollableTab style={stylesTab.tabHead} />
                      )}
                    >
                      <Tab
