        ...
        <Grid>
            ...
            <Row>
                ...
                <Badge info style={{position:"absolute", bottom: 10, right: 10 }}>
                  <Text style={{fontSize:14}}>Cantidad de equipaje: {this.props.contadorEquipaje==null?0:this.props.contadorEquipaje}</Text>
                </Badge>
            </Row>
            ...
            >
              <View>
                <View style={{padding: 30, paddingTop:60, backgroundColor: "#015d7c"}}>
                  <Text style={{color: "#fff"}}>Documento de identidad</Text>
                  <TextInput keyboardType="numeric" style={{ backgroundColor: "#fff", height: 40, borderColor: 'gray', borderWidth: 1 }} onChangeText={_cedula=>this.setState({_cedula})} value={this.state._cedula} />
